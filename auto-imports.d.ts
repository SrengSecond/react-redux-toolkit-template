...
export {}
declare global {
  const bundleAction: typeof import('./src/redux/bundle/bundleSlice.slice')['bundleAction']
  const bundleReducer: typeof import('./src/redux/bundle/bundleSlice.slice')['bundleReducer']
  const createRef: typeof import('react')['createRef']
  const forwardRef: typeof import('react')['forwardRef']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const productAction: typeof import('./src/redux/product/productSlice.slice')['productAction']
  const productAsyncAction: typeof import('./src/redux/product/productSlice.slice')['productAsyncAction']
  const productReducer: typeof import('./src/redux/product/productSlice.slice')['productReducer']
  const redux: typeof import('./src/redux/index')['default']
  const request: typeof import('./src/request/index')['default']
  const startTransition: typeof import('react')['startTransition']
  const useAppDispatch: typeof import('./src/hooks/useRedux')['useAppDispatch']
  const useAppSelector: typeof import('./src/hooks/useRedux')['useAppSelector']
